...
.timeline {
  ...
  .timeline-item {
    ...
    &.left {
      ...
      .dot { left: 100%; transform: translate(-50%, -50%); }
    }
    &.right {
      margin-left: auto;
      .card { margin-right: auto; }
      .dot { left: 0; transform: translate(-50%, -50%); }
    }
    ...
    .year { letter-spacing: .04em; }
    .item-subtitle { opacity: .85; }
...
@media (max-width: 992px) {
  .timeline {
    .timeline-line { left: 24px; margin: 0; }
    .timeline-item {
      width: 100%;
      padding-left: 3.25rem; padding-right: 0;
      &.left, &.right {
        .card-link-wrapper .card { margin: 0; }
...
@media (prefers-reduced-motion: reduce) {
  .timeline .timeline-item { transition: none !important; opacity: 1 !important; transform: none !important; }
}
</style>
